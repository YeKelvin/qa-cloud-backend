...
def init_permission():
    ...
    _create_permission(name='下移元素', method='PATCH', endpoint='/script/element/child/move/down')
    _create_permission(name='移动元素', method='POST', endpoint='/script/element/child/move')
    ...
    _create_permission(name='查询变量集下的变量', method='GET', endpoint='/script/variables/in/set')
    ...
    _create_permission(name='查询模板下的请求头', method='GET', endpoint='/script/http/headers/in/template')
