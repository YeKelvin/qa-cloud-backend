...
def init_permission():
    ...
    _create_permission(name='根据元素编号列表查询子代元素', method='GET', endpoint='/script/elements/children')
    _create_permission(name='新增集合元素', method='POST', endpoint='/script/collection')
    _create_permission(name='新增子代元素', method='POST', endpoint='/script/element/child')
    _create_permission(name='根据列表新增子代元素', method='POST', endpoint='/script/element/children')
    _create_permission(name='新增 HTTP Sampler 元素', method='POST', endpoint='/script/element/http/sampler')
    _create_permission(name='修改元素', method='PUT', endpoint='/script/element')
    _create_permission(name='修改 HTTP Sampler 元素', method='PUT', endpoint='/script/element/http/sampler')
    ...
    _create_permission(name='查询测试集合的JSON脚本', method='GET', endpoint='/script/collection/json')
    _create_permission(name='查询测试分组的JSON脚本', method='GET', endpoint='/script/group/json')
    _create_permission(name='查询片段集合的JSON脚本', method='GET', endpoint='/script/snippets/json')
    ...
    _create_permission(name='查询变量集下的变量', method='GET', endpoint='/script/variables/by/dataset')
